...
if __name__ == '__main__':
    ...
    plt.figure()
    plt.hist(total_kr, range=(0,100), bins=20, color='r', label='Korean-total' , density ='True')
    plt.hist(total_en, range=(0,100), bins=20, color='b', label='English-total', density ='True', alpha=0.5)
