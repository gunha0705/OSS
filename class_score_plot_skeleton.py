...
if __name__ == '__main__':
    ...
    plt.figure()
    plt.hist(total_kr, range=(0,100), bins=20, color='r', histtype='step', density='true')
    plt.hist(total_en, range=(0,100), bins=20, color='b', histtype='step', density='true', alpha=0.5)
